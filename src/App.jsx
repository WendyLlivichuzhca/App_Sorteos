...
import AdminLugaresSorteo from "./pages/admin/AdminLugaresSorteo.jsx";
      ...
      <AuthProvider>
        <AppProvider>
          ...
          <Routes>
            ...
            <Route path="/admin/sorteos/:sorteoId/lugares" element={<ProtectedRoute><AdminLugaresSorteo /></ProtectedRoute>} />
