      ...
      <div className={styles.tableCard}>
        ...
        <div style={{ padding: "16px 18px", borderBottom: "1px solid #E3E8E5", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "14px", flexWrap: "wrap" }}>
          <input
            ...
            style={{ flex: 1, minWidth: "220px", maxWidth: "400px", padding: "10px 14px", borderRadius: "10px", border: "1.5px solid #E3E8E5", background: "#F7FAF8", color: "#101512", fontSize: "12px" }}
          />
          <label style={{ display: "flex", alignItems: "center", gap: "7px", fontSize: "12px", fontWeight: 600, color: "#5B6660", cursor: "pointer", whiteSpace: "nowrap" }}>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            ...
            {paginados.map((b) => (
              <tr key={b.id}>
                <td><strong style={{ color: "#146B45" }}>#{b.numero}</strong></td>
