      ...
      <div className={styles.tableCard}>
        ...
        <div style={{ padding: "16px 18px", borderBottom: "1px solid #E3E8E5" }}>
          <input
            ...
            style={{ width: "100%", maxWidth: "400px", padding: "10px 14px", borderRadius: "10px", border: "1.5px solid #E3E8E5", background: "#F7FAF8", color: "#101512" }}
          />
        </div>
        ...
        {filtered.length > 0 && (
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 18px", borderTop: "1.5px solid #E3E8E5" }}>
            <span style={{ fontSize: "11.5px", color: "#5B6660" }}>
        ...
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            ...
            <div style={{ padding: "20px" }}>
              ...
              <div style={{ marginTop: "16px", background: "#F7FAF8", padding: "14px", borderRadius: "10px" }}>
                ...
                {!historialLoading && historial.length === 0 && (
                  <p style={{ marginTop: "8px", fontSize: "13px", color: "#5B6660" }}>Sin compras registradas.</p>
                )}
                <ul style={{ marginTop: "8px", fontSize: "13px", color: "#5B6660", lineHeight: "1.6" }}>
                  {historial.map((h) => (
                    <li key={h.id}>
